...
export default function PillarsSection() {
  ...
  return (
    <section id="pillars" className="relative bg-ink py-24 md:py-32 px-6 overflow-hidden" ref={ref}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <motion.h2
          ...
          className="font-anton text-cream text-4xl sm:text-5xl md:text-6xl text-center mb-16 leading-[0.95]"
        >
          WHAT WE STAND FOR
        </motion.h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {PILLARS.map((pillar, i) => (
            <motion.div
              ...
              className="group bg-white/[0.03] border border-white/[0.06] rounded-sm p-8 md:p-10 hover:bg-white/[0.06] hover:border-gold/20 transition-all duration-500 hover:-translate-y-1"
            >
              <pillar.icon className="w-10 h-10 text-gold mb-6 group-hover:scale-110 transition-transform duration-300" strokeWidth={1.5} />
              <h3 className="font-anton text-cream text-2xl md:text-3xl mb-4 leading-tight">{pillar.title}</h3>
