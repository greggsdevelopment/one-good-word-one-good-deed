...
export default function StickyNav({ logoUrl }) {
  ...
  const linkClass = "font-barlow-condensed text-sm text-cream/70 hover:text-gold tracking-wider uppercase transition-colors duration-300 min-h-[44px] flex items-center";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden lg:flex items-center gap-4 xl:gap-5">
              ...
              <a href="#contact" onClick={(e) => handleScroll(e, '#contact')} className={linkClass}>
                Contact
              </a>
              <a
                href="#pledge"
          ...
          >
            <div className="flex flex-col gap-1 flex-1 justify-center">
              ...
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: PAGE_LINKS.length * 0.07 }}
              >
                <a
                  href="#contact"
